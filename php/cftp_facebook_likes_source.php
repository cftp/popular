...
class cftp_facebook_likes_source implements cftp_analytics_source {
	...
	function columns_head($defaults) {
		$defaults['facebook_likes'] = 'Facebook Likes';
		return $defaults;
	}
	...
	public function registerSettings( $option_group, $section_id, $page ) {
		$option_name = 'cftp_popular_facebook_likes';
		register_setting(
	...
	public function displaySettings() {
		...
		echo 'Facebook Likes:'.$this->getPageViewsForURL('http://www.tomjn.com/398/add_action-considered-harmful/');
	}
